...
export default function Home() {
  return (
    <main className="flex-1">
      ...
      <section className="px-4 sm:px-6 pt-10 sm:pt-24 pb-10 sm:pb-16 max-w-6xl mx-auto w-full">
      ...
      <section id="how" className="px-4 sm:px-6 py-14 sm:py-24 max-w-3xl mx-auto w-full">
      ...
      <section id="why" className="px-4 sm:px-6 py-14 sm:py-24 max-w-5xl mx-auto w-full">
