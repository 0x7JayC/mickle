    ...
    <main className="flex-1 relative">
      ...
      <nav className="sticky top-4 z-50 px-4 sm:px-6 mt-4">
        <div className="max-w-6xl mx-auto glass-pill px-4 py-2.5 flex items-center justify-between gap-3">
          ...
          <div className="hidden sm:block text-xs font-mono text-foreground/60">palette comparison</div>
          <Link href="/" className="text-xs text-foreground/60 hover:text-foreground shrink-0">← back</Link>
        </div>
      </nav>
